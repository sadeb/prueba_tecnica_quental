...
| Spring Boot | 2.7.18 | Última 2.7.x. Gestiona Spring Kafka 2.8.x, Spring Data JPA 2.7, SDN 6.3, Liquibase 4.9 |
...
| Liquibase | 4.9.x (gestionada) | Bonus migraciones ([spec/08-bonus.md](../spec/08-bonus.md) B4); changelog maestro YAML + formatted SQL ([ADR-011](../decisions/ADR-011-liquibase-migraciones.md)) |
