...
## Pasos
1. `projects/backend/pom.xml`: parent `spring-boot-starter-parent` 2.7.18, `java.version` 11, starters `web`, `validation`, `data-jpa`, `data-neo4j`, `kafka`, `security`, `actuator`, `test`, `kafka-test`, driver `postgresql`, `flyway-core`, `springdoc-openapi-ui` 1.7.0, `h2` (test). Maven wrapper.
